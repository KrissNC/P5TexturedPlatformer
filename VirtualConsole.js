...
export class VirtualConsole {
  ...
  setInk(ink) {
    // these become ineffective when CONSOLECOLOR_MODE is used
    this.inkC = ink;
  }
  ...
  draw_ConsoleColor() {
    ...
    //console.log(this);
    //console.log(this.backgroundC)
    let bgc = this.P5colors.getBGColor(this.backgroundC);

    //console.log("bgc" + bgc)

    // console.log(this.P5colors)
